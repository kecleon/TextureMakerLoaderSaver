...
package kabam.rotmg.arena.view {
	...
	public class ArenaLeaderboardListItem extends Sprite {
		...
		public function setColor() : void {
			...
			this.playerName.setColor(loc1);
			this.waveNumber.setColor(loc1);
			this.runTime.setColor(loc1);
			this.rankNumber.setColor(loc1);
		}
		...
		private function makeBackground() : Sprite {
			...
			loc1.graphics.drawRect(0,0,750,60);
		...
		private function makePetIconBackground() : Sprite {
			...
			loc1.graphics.drawRoundRect(0,0,40,40,10,10);
			loc1.graphics.endFill();
			loc1.visible = false;
			return loc1;
		}
		...
		private function formatTime(param1:int) : String {
			var loc2:int = Math.floor(param1 / 60);
			var loc3:String = (loc2 < 10?"0":"") + loc2.toString();
			var loc4:int = param1 % 60;
			var loc5:String = (loc4 < 10?"0":"") + loc4.toString();
			return loc3 + ":" + loc5;
		}
