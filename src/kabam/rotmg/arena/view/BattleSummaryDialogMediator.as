...
package kabam.rotmg.arena.view {
	...
	public class BattleSummaryDialogMediator extends Mediator {
		...
		override public function initialize() : void {
			...
			var loc1:Boolean = this.bestRunModel.entry.currentWave > this.currentRunModel.entry.currentWave || this.bestRunModel.entry.currentWave == this.currentRunModel.entry.currentWave && this.bestRunModel.entry.runtime < this.currentRunModel.entry.runtime;
			var loc2:ArenaLeaderboardEntry = !!loc1?this.bestRunModel.entry:this.currentRunModel.entry;
			this.view.setBestRun(loc2.currentWave,loc2.runtime);
