...
package kabam.rotmg.classes.view {
	...
	public class ClassDetailView extends Sprite {
		...
		public function ClassDetailView() {
			...
			this.classNameText.filters = [loc1];
			...
			this.classDescriptionText.filters = [loc1];
			...
			this.questCompletionText.filters = [loc1];
			...
			this.levelTitleText.filters = [loc1];
			...
			this.fameTitleText.filters = [loc1];
			...
			this.nextGoalDetailText.filters = [loc1];
