...
package kabam.rotmg.editor {
	...
	import kabam.rotmg.editor.commands.SetupEditorCommand;
	...
	import kabam.rotmg.editor.signals.SetupEditorSignal;
	...
	public class EditorConfig implements IConfig {
		...
		public function configure() : void {
			...
			this.startupSequence.addSignal(SetupAnalyticsSignal);
