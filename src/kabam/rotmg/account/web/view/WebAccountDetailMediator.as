package kabam.rotmg.account.web.view {
	...
	public class WebAccountDetailMediator extends Mediator {
		...
		private function onVerify():void {
			var loc1:AppEngineClient = StaticInjectorContext.getInjector().getInstance(AppEngineClient);
			loc1.complete.addOnce(this.onComplete);
			loc1.sendRequest("/account/sendVerifyEmail", this.account.getCredentials());
		}
