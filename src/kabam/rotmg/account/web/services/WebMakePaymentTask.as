...
package kabam.rotmg.account.web.services {
	...
	public class WebMakePaymentTask extends BaseTask implements MakePaymentTask {
		...
		override protected function startTask() : void {
			...
			Parameters.save();
			var loc1:PaymentMethod = PaymentMethod.getPaymentMethodByLabel(this.data.paymentMethod);
			var loc2:String = loc1.getURL(this.model.offers.tok,this.model.offers.exp,this.data.offer);
			navigateToURL(new URLRequest(loc2),"_blank");
			completeTask(true);
		}
	}
}
