package kabam.rotmg.account.securityQuestions.mediators {
	...
	public class SecurityQuestionsMediator extends Mediator {
		...
		private function onSaveQuestions(param1:MouseEvent):void {
			...
			var loc2:SecurityQuestionsData = new SecurityQuestionsData();
			loc2.answers = [];
			for each(loc3 in this.securityQuestionsModel.securityQuestionsAnswers) {
				loc2.answers.push(Base64.encode(loc3));
			}
			this.saveQuestions.dispatch(loc2);
		}
	}
}
