...
package kabam.rotmg.friends.view {
	...
	public class FriendListItem extends FListItem {
		...
		override protected function init(param1:Number, param2:Number) : void {
			...
			var loc3:IconButtonFactory = StaticInjectorContext.getInjector().getInstance(IconButtonFactory);
			this._jumpButton = loc3.create(AssetLibrary.getImageFromSet("lofiInterface2",3),TextKey.FRIEND_TELEPORT_TITLE,"","");
			...
			this._whisperButton = loc3.create(AssetLibrary.getImageFromSet("lofiInterfaceBig",21),TextKey.PLAYERMENU_PM,"","");
