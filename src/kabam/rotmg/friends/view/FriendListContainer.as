package kabam.rotmg.friends.view {
	...
	public class FriendListContainer extends Sprite {
		...
		public function FriendListContainer(param1:Number, param2:Number) {
			...
			loc3.graphics.beginFill(2245785);
			loc3.graphics.drawRect(0, 0, this._width, this._height);
		...
		override public function removeChildAt(param1:int):DisplayObject {
			var loc2:Sprite = this._itemContainer.getChildAt(param1) as Sprite;
			if (loc2 != null) {
				this._currentY = this._currentY - (loc2.height + this.GAP_Y);
			}
