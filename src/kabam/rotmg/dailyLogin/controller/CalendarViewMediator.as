...
package kabam.rotmg.dailyLogin.controller {
	...
	public class CalendarViewMediator extends Mediator {
		...
		private function onClaimReward(param1:ClaimDailyRewardResponse) : void {
			...
			if(param1.gold > 0) {
				loc2 = "gold";
				this.addTextLine.dispatch(ChatMessage.make(Parameters.SERVER_CHAT_NAME,(param1.gold > 0?param1.gold:param1.quantity) + "x " + loc2 + " was claimed.",-1,-1,"",false));
				...
				loc2 = LineBuilder.getLocalizedStringFromKey(ObjectLibrary.typeToDisplayId_[param1.itemId]);
				this.addTextLine.dispatch(ChatMessage.make(Parameters.SERVER_CHAT_NAME,(param1.gold > 0?param1.gold:param1.quantity) + "x " + loc2 + " was claimed and will be sent to the gift chests in your vault.",-1,-1,"",false));
			}
		}
	}
}
