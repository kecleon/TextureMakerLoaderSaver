...
package kabam.rotmg.text.view {
	...
	public class TextFieldDisplayConcrete extends Sprite implements TextFieldDisplay {
		...
		private function setFormatProperties() : void {
			var loc1:TextFormat = new TextFormat();
			loc1.size = this.size;
		...
		private function setYToMiddle() : void {
			this.textField.height;
			var loc1:TextFormat = this.textField.getTextFormat();
			var loc2:Number = this.getSpecificXHeight(loc1);
			var loc3:Number = this.getSpecificVerticalSpace(loc1);
