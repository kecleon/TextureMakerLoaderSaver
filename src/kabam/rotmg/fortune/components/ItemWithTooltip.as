package kabam.rotmg.fortune.components {
	...
	public class ItemWithTooltip extends Sprite implements TooltipAble {
		...
		public function ItemWithTooltip(param1:int, param2:int = 100, param3:Boolean = false) {
			...
			super();
			this.itemId = param1;
			var loc4:BitmapData = ObjectLibrary.getRedrawnTextureFromType(param1, param2, true, false);
			var loc5:BitmapData = ObjectLibrary.getRedrawnTextureFromType(param1, param2, true, false);
			this.itemBitmap = new Bitmap(loc5);
