package kabam.rotmg.fame.service {
	...
	public class RequestCharacterFameTask extends BaseTask {
		...
		private function getDataPacket():Object {
			var loc1:Object = {};
			loc1.accountId = this.accountId;
			loc1.charId = this.accountId == "" ? -1 : this.charId;
			return loc1;
		}
		...
		private function getDeathDate():String {
			var loc1:Number = Number(this.xml.CreatedOn) * 1000;
			var loc2:Date = new Date(loc1);
			var loc3:DateFormatterReplacement = new DateFormatterReplacement();
			loc3.formatString = "MMMM D, YYYY";
			return loc3.format(loc2);
		}
