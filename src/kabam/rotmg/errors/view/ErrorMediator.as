package kabam.rotmg.errors.view {
	...
	public class ErrorMediator extends Mediator {
		...
		private function addGlobalErrorListener():void {
			var loc1:IEventDispatcher = IEventDispatcher(this.loaderInfo[this.UNCAUGHT_ERROR_EVENTS]);
			loc1.addEventListener(this.UNCAUGHT_ERROR, this.handleUncaughtError);
		}

		private function removeGlobalErrorListener():void {
			var loc1:IEventDispatcher = IEventDispatcher(this.loaderInfo[this.UNCAUGHT_ERROR_EVENTS]);
			loc1.removeEventListener(this.UNCAUGHT_ERROR, this.handleUncaughtError);
		}
