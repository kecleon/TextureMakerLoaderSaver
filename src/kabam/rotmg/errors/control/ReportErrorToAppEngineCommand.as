package kabam.rotmg.errors.control {
	...
	public class ReportErrorToAppEngineCommand {
		...
		public function execute():void {
			...
			this.getMessage();
			var loc1:Array = [];
			loc1.push("Build: " + this.setup.getBuildLabel());
			loc1.push("message: " + this.getMessage());
			loc1.push("stackTrace: " + this.getStackTrace());
			loc1.push(CapabilitiesUtil.getHumanReadable());
