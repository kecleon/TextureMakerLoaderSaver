package kabam.rotmg.death.view {
	...
	public class ResurrectionView extends Sprite {
		...
		private function createBackground(param1:BitmapData):void {
			...
			var loc2:Array = [0.33, 0.33, 0.33, 0, 0, 0.33, 0.33, 0.33, 0, 0, 0.33, 0.33, 0.33, 0, 0, 0.33, 0.33, 0.33, 1, 0];
			var loc3:ColorMatrixFilter = new ColorMatrixFilter(loc2);
			loc4 = new Bitmap(param1);
			loc4.filters = [loc3];
			addChild(loc4);
		}
