package kabam.rotmg.game.view {
	...
	public class GameSpriteMediator extends Mediator {
		...
		private function onShowPackage():void {
			var loc1:PackageInfo = this.packageModel.startupPackage();
			if (loc1) {
		...
		private function onReconnect(param1:ReconnectEvent):void {
			...
			loc2.server = param1.server_;
			loc2.gameId = param1.gameId_;
			loc2.createCharacter = param1.createCharacter_;
			loc2.charId = param1.charId_;
			loc2.keyTime = param1.keyTime_;
			loc2.key = param1.key_;
			loc2.isFromArena = param1.isFromArena_;
