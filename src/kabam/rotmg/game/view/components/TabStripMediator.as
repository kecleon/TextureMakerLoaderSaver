package kabam.rotmg.game.view.components {
	...
	public class TabStripMediator extends Mediator {
		...
		private function onTabHotkey():void {
			var loc1:int = this.view.currentTabIndex + 1;
			loc1 = loc1 % this.view.tabs.length;
			this.view.setSelectedTab(loc1);
		}
		...
		private function onUpdateBackPack(param1:Boolean):void {
			...
			if (param1) {
				loc2 = this.hudModel.gameSprite.map.player_;
				this.view.addTab(this.iconFactory.makeIconBitmap(TabConstants.BACKPACK_ICON_ID), new BackpackTabContent(loc2));
				this.updateBackpack.remove(this.onUpdateBackPack);
			}
		}
