package kabam.rotmg.game.view {
	...
	public class MapOverlayMediator extends Mediator {
		...
		private function onAddSpeechBalloon(param1:AddSpeechBalloonVO):void {
			var loc2:String = this.account.isRegistered() || this.chatFilter.guestChatFilter(param1.go.name_) ? param1.text : ". . .";
			var loc3:SpeechBalloon = new SpeechBalloon(param1.go, loc2, param1.name, param1.isTrade, param1.isGuild, param1.background, param1.backgroundAlpha, param1.outline, param1.outlineAlpha, param1.textColor, param1.lifetime, param1.bold, param1.hideable);
			this.view.addSpeechBalloon(loc3);
		}
	}
}
