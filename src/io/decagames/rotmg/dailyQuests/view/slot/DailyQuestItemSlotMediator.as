package io.decagames.rotmg.dailyQuests.view.slot {
	...
	public class DailyQuestItemSlotMediator extends Mediator {
		...
		override public function initialize():void {
			...
			this.tooltip = new EquipmentToolTip(this.view.itemID, this.view.type == DailyQuestItemSlotType.REQUIREMENT ? null : loc1, loc2, InventoryOwnerTypes.CURRENT_PLAYER);
