...
package io.decagames.rotmg.pets.commands {
	...
	public class HatchPetCommand extends Command {
		...
		override public function execute() : void {
			var loc1:SkinVO = this.model.getSkinVOById(this.vo.petSkin);
			var loc2:Boolean = loc1.isOwned;
			this.model.unlockSkin(this.vo.petSkin);
			this.openDialog.dispatch(new PetHatchingDialog(this.vo.petName,this.vo.petSkin,this.vo.itemType,!loc2,loc1));
		}
	}
}
