...
package io.decagames.rotmg.ui.tabs {
	...
	public class TabContentBackground extends SliceScalingBitmap {
		...
		public function addDecor(param1:int, param2:int, param3:int, param4:int) : void {
			...
			var loc5:int = param1;
			while(loc5 < param2) {
				this.bitmapData.copyPixels(this.decorBitmapData,new Rectangle(this.decorSliceRectangle.x,0,this.decorSliceRectangle.width,this.decorBitmapData.height),new Point(this.decorSliceRectangle.x + loc5,0));
				loc5++;
			}
