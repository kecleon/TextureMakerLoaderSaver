...
package io.decagames.rotmg.ui.tabs {
	...
	public class TabButton extends SliceScalingButton {
		...
		public function TabButton(param1:String) {
			...
			var loc2:SliceScalingBitmap = TextureParser.instance.getSliceScalingBitmap("UI",this.defaultBitmap);
			super(loc2);
			bitmap.name = "TabButton";
			loc2.addMargin(0,this.buttonType == BORDERLESS?0:int(SELECTED_MARGIN));
