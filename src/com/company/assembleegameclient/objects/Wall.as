	...
	public class Wall extends GameObject {
		...
		override public function draw(param1:Vector.<IGraphicsData>, param2:Camera, param3:int):void {
			...
			while (loc5 < this.faces_.length) {
				...
				if (loc8 == null || loc8.texture_ == null || loc8 != null && loc8.obj_ is Wall && !loc8.obj_.dead_) {
					loc7.blackOut_ = true;
				} else {
		...
		public function rebuild3D():void {
			...
			var loc1:int = x_;
			var loc2:int = y_;
			var loc3:Vector.<Number> = new <Number>[loc1, loc2, 1, loc1 + 1, loc2, 1, loc1 + 1, loc2 + 1, 1, loc1, loc2 + 1, 1];
		...
		private function addWall(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number):void {
			var loc7:Vector.<Number> = new <Number>[param1, param2, param3, param4, param5, param6, param4, param5, param6 - 1, param1, param2, param3 - 1];
			var loc8:Face3D = new Face3D(texture_, loc7, UVT, true, true);
