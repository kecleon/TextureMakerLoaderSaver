package com.company.assembleegameclient.objects.particles {
	...
	public class BaseParticle extends BasicObject {
		...
		override public function draw(param1:Vector.<IGraphicsData>, param2:Camera, param3:int):void {
			var loc4:Number = this.bitmapFill_.bitmapData.width / 2;
			var loc5:Number = this.bitmapFill_.bitmapData.height / 2;
			this.vS_[6] = this.vS_[0] = posS_[3] - loc4;
			this.vS_[3] = this.vS_[1] = posS_[4] - loc5;
			this.vS_[4] = this.vS_[2] = posS_[3] + loc4;
			this.vS_[7] = this.vS_[5] = posS_[4] + loc5;
