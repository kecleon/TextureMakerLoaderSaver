...
package com.company.assembleegameclient.account.ui {
	...
	public class OfferRadioButton extends Sprite implements Selectable {
		...
		private function makeCoinImage() : void {
			...
			var loc1:Bitmap = new Bitmap(this.coinBitmap);
			loc1.x = this.toggle.x + 35;
		...
		private function updateBackgroundColor() : void {
			var loc1:int = !!this.isSelected?int(SELECTED_COLOR):!!this.isOver?int(OVER_COLOR):int(DEFAULT_COLOR);
			this.background.setColor(loc1);
		}
