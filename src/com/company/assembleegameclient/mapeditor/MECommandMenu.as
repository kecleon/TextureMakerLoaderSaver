...
package com.company.assembleegameclient.mapeditor {
	...
	public class MECommandMenu extends CommandMenu {
		...
		public function MECommandMenu() {
			super();
			var loc1:PlayerModel = StaticInjectorContext.getInjector().getInstance(PlayerModel);
			...
			if(loc1.isAdmin() || DynamicSettings.settingExists("UGDOpenSubmission") && DynamicSettings.getSettingValue("UGDOpenSubmission") == 1) {
