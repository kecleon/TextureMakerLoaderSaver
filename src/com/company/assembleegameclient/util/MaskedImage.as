...
package com.company.assembleegameclient.util {
	...
	public class MaskedImage {
		...
		public function mirror(param1:int = 0) : MaskedImage {
			var loc2:BitmapData = BitmapUtil.mirror(this.image_,param1);
			var loc3:BitmapData = this.mask_ == null?null:BitmapUtil.mirror(this.mask_,param1);
			return new MaskedImage(loc2,loc3);
		}
