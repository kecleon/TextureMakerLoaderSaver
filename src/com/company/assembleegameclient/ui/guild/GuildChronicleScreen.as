package com.company.assembleegameclient.ui.guild {
	...
	public class GuildChronicleScreen extends Sprite {
		...
		private function addList():void {
			...
			this.guildPlayerList_ = new GuildPlayerList(50, 0, loc1 == null ? "" : loc1.name_, loc1.guildRank_);
		...
		private function showError(param1:String):void {
			var loc2:Dialog = new Dialog(TextKey.GUILD_CHRONICLE_LEFT, param1, TextKey.GUILD_CHRONICLE_RIGHT, null, "/guildError");
			loc2.addEventListener(Dialog.LEFT_BUTTON, this.onErrorTextDone);
			stage.addChild(loc2);
		}

		private function onErrorTextDone(param1:Event):void {
			var loc2:Dialog = param1.currentTarget as Dialog;
			stage.removeChild(loc2);
			this.addList();
		}
