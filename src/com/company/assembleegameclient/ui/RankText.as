...
package com.company.assembleegameclient.ui {
	...
	public class RankText extends Sprite {
		...
		public function makeText() : TextFieldDisplayConcrete {
			var loc1:int = !!this.largeText_?18:16;
			var loc2:TextFieldDisplayConcrete = new TextFieldDisplayConcrete();
			loc2.setSize(loc1).setColor(11776947);
			loc2.setBold(this.largeText_);
			return loc2;
		}
		...
		public function draw(param1:int) : void {
			...
			onTextChanged = function():void {
				...
				var loc1:int = icon.x + icon.width;
				background.graphics.clear();
				background.graphics.beginFill(0,0.4);
				var loc2:Number = icon.height + 8;
				background.graphics.drawRoundRect(-2,icon.y - 3,loc1 + 6,loc2,12,12);
