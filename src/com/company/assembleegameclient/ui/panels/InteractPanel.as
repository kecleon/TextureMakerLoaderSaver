package com.company.assembleegameclient.ui.panels {
	...
	public class InteractPanel extends Sprite {
		...
		public function draw():void {
			var loc1:IInteractiveObject = null;
			var loc2:Panel = null;
			if (this.overridePanel_ != null) {
			...
			loc1 = this.requestInteractive();
			if (this.currentPanel == null || loc1 != this.currObj_) {
				this.currObj_ = loc1;
				this.partyPanel_ = new PartyPanel(this.gs_);
				if (this.currObj_ != null) {
					loc2 = this.currObj_.getPanel(this.gs_);
				} else {
					loc2 = this.partyPanel_;
				}
				this.setPanel(loc2);
			}
