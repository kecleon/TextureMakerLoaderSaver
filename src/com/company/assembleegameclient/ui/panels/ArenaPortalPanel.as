...
package com.company.assembleegameclient.ui.panels {
	...
	public class ArenaPortalPanel extends Panel {
		...
		public function ArenaPortalPanel(param1:AGameSprite, param2:ArenaPortal) {
			...
			var loc3:Player = gs_.map.player_;
		...
		private function makeTitle() : StaticTextDisplay {
			...
			loc1.setSize(18).setColor(16777215).setTextWidth(WIDTH).setWordWrap(true).setMultiLine(true).setAutoSize(TextFieldAutoSize.CENTER).setBold(true).setHTML(true);
			loc1.setStringBuilder(new LineBuilder().setParams(TextKey.ARENA_PORTAL_PANEL_TITLE).setPrefix("<p align=\"center\">").setPostfix("</p>"));
