package com.company.assembleegameclient.ui.icons {
	...
	public class IconButton extends Sprite implements TooltipAble {
		...
		private function getCroppedBitmapData(param1:BitmapData, param2:int):BitmapData {
			...
			var loc3:Rectangle = new Rectangle(0, param2, param1.width, param1.height - param2);
			var loc4:BitmapData = new BitmapData(param1.width, param1.height - param2);
			loc4.copyPixels(param1, loc3, new Point(0, 0));
			return loc4;
		}
