...
package com.company.assembleegameclient.ui.options {
	...
	public class ChoiceBox extends Sprite {
		...
		public function ChoiceBox(param1:Vector.<StringBuilder>, param2:Array, param3:Object, param4:Number = 16777215) {
			...
			graphicsData_ = new <IGraphicsData>[this.internalFill_,this.lineStyle_,this.path_,GraphicsUtil.END_STROKE,GraphicsUtil.END_FILL];
			super();
			this.color = param4;
			this.labels_ = param1;
			this.values_ = param2;
		...
		public function setValue(param1:*, param2:Boolean = true) : void {
			var loc3:int = 0;
			while(loc3 < this.values_.length) {
				if(param1 == this.values_[loc3]) {
					if(loc3 == this.selectedIndex_) {
						return;
					}
					this.selectedIndex_ = loc3;
					break;
				}
				loc3++;
			}
