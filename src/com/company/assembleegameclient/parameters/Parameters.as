package com.company.assembleegameclient.parameters {
	...
	public class Parameters {
		...
		public static const skinTypes16:Vector.<int> = new <int>[1027, 1028, 1029, 1030, 10973, 19494, 19531, 6346, 30056, 5505];
		...
		public static function setKey(param1:String, param2:uint):void {
			var loc3:* = null;
			for (loc3 in keyNames_) {
				if (data_[loc3] == param2) {
					data_[loc3] = KeyCodes.UNSET;
				}
			}
			data_[param1] = param2;
		}
